...
from blockchain.transaction import Transaction  # Ensure correct import
...
def setup_routes(app, blockchain, port):
    ...
    def add_transaction():
        ...
        try:
            # Ensure that the transaction is a dictionary
    ...
    def get_pending_transactions():
        # Since mempool contains dicts, directly return them
        pending_transactions = list(blockchain.mempool.values())
        ...
        for block in blockchain.chain:
            for tx in block.transactions:
                if tx['sender'] == wallet_address or tx['recipient'] == wallet_address:
                    transactions.append(tx)  # tx is a dict
